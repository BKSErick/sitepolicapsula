...
export type SolutionIcon = 'wind' | 'pill' | 'arrows' | 'flask' | 'wrench';
...
export const home = {
  ...
  heroFacts: [
    ['Foco', 'Cadeia do aço'],
    ['Frentes', '05 técnicas'],
    ['Catálogo', '10 produtos próprios'],
  ],
  heroNote: ['Envio', 'Chegada', 'Bancada'],
  evidence: [
    ['05', 'frentes técnicas'],
    ['10', 'produtos próprios'],
    ['08', 'grandes grupos na carteira'],
    ['NR10 · NR12', 'adequação de máquinas'],
  ],
} as const;
...
/** Itens do Pedido Pronto: os dez produtos e as cinco frentes como serviço. */
...
const coreRoutes: PublicRoute[] = [
  ...
  },
  {
    ...
    kind: 'solutions',
    label: 'Soluções',
    eyebrow: 'CINCO FRENTES · UM CAMINHO DA AMOSTRA',
    heading: 'Do tubo pneumático à bancada de preparação.',
    introduction:
      'Cinco frentes técnicas cobrem o caminho inteiro da amostra: o sistema que transporta, a cápsula que viaja, a estação que recebe, a bancada que prepara e a manutenção que mantém tudo em operação.',
    meta: {
      title: 'Soluções em Transporte e Preparação de Amostras | Policápsula',
      description:
        'Transporte pneumático, cápsulas, estações e amortecedores, preparação de amostras e engenharia de manutenção para a indústria do aço.',
    },
  },
  {
    path: '/produtos/',
...
/** Rotas fixas do site, na ordem de leitura: início, empresa, soluções e as cinco frentes, depois o resto. */
